...
class RLBridgeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetFrame = channel.unary_unary(
                '/openra.rl.RLBridge/GetFrame',
                request_serializer=rl__bridge__pb2.GetFrameRequest.SerializeToString,
                response_deserializer=rl__bridge__pb2.GetFrameResponse.FromString,
                _registered_method=True)
...
class RLBridgeServicer(object):
    ...
    def GetFrame(self, request, context):
        """Unary: capture the current rendered frame as a PNG byte array.
        Requires the game to be running with a real renderer
        (i.e. NOT Game.Platform=Null). Returns empty image when headless.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RLBridgeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetFrame': grpc.unary_unary_rpc_method_handler(
                    servicer.GetFrame,
                    request_deserializer=rl__bridge__pb2.GetFrameRequest.FromString,
                    response_serializer=rl__bridge__pb2.GetFrameResponse.SerializeToString,
            ),
    }
...
class RLBridge(object):
    ...
    def GetFrame(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/openra.rl.RLBridge/GetFrame',
            rl__bridge__pb2.GetFrameRequest.SerializeToString,
            rl__bridge__pb2.GetFrameResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
